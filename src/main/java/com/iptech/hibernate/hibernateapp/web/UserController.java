package com.iptech.hibernate.hibernateapp.web;
...
import com.iptech.hibernate.hibernateapp.service.AddressService;
import com.iptech.hibernate.hibernateapp.service.UserService;
...
public class UserController {
	...
	public String postOneUser (@PathVariable Long userId, User user) {
		...
		Address address = addressService.save(userAddress);
		user.setAddress(address);
		userService.saveUser(user);
